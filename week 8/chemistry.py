def main():
    ...
    # Round the moral mass
    round_molar_mass = round(molar_mass,5)

    # Round the number of moles
    round_num_moles = round(num_moles,5)

    # Print the molar mass.
    print(f"{round_molar_mass} grams/mole")

    # Print the number of moles.
    print(f"{round_num_moles} moles")
